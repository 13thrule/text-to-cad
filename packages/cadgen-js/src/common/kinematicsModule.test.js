...
async function nestedEffects(t, values) {
  stubSidecar(t, { schemaVersion: SOURCE_SIDECAR_SCHEMA_VERSION, kinematics: NESTED });
  const definition = await loadKinematicsModuleDefinition(SIDECAR_URL, { cadPath: "gripper.step" });
