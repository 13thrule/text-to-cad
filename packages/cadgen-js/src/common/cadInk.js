...
const PALETTES = Object.freeze({
  light: Object.freeze({ feature: "#253443", tangent: "#667788", seam: "#495b6c", degenerate: "#667788" }),
  dark: Object.freeze({ feature: "#96a5b5", tangent: "#657787", seam: "#7d8fa0", degenerate: "#657787" })
});

export function resolveCadEdgeSettings(value = null, { colorMode = "light" } = {}) {
  const palette = PALETTES[colorMode === "dark" ? "dark" : "light"];
  return {
